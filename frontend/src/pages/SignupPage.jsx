    ...
    <div className='min-h-screen flex items-center justify-center hero-bg '>
        <form className='bg-gray-950 p-6 rounded shadow-md w-96 text-white'>
            ...
            <div className='mb-4'>
                ...
                <input type="text" id="username" className='shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline' placeholder="Username" required/>
            </div>
            <div className='mb-4'>
            ...
            <button disabled={true} type="submit" className='bg-red-600 hover:bg-red-500 text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full'>Register</button>
            <p className='text-center text-sm text-gray-500 mt-4'>Already have an account? <Link to="/login" className='text-red-500 hover:text-red-400'>Login</Link></p>
        </form>
    </div>
  )
}
