...
const HomeScreen = () => {
  return (
    <div className='min-h-[100%] min-w-[100%] bg-black flex flex-col items-center justify-center  '>
      <Navbar/>
      <main className='hero-bg h-screen flex flex-col items-center justify-center w-full h-full'>
        ...
        <form className='flex flex items-center mt-4 w-full max-w-md'>
      ...
      {/* 2nd section */}
      <section className='py-10 bg-black text-white'>
        <div className='flex flex-col-reverse max-w-6xl mx-auto items-center justify-center md:flex-row flex-col px-4 md:px-2'>
          {/* left side */}
          <div className='flex-1 relative'>
            <img src='/section2.png' alt='Mobile image' className='mt-4 z-20 relative' />
            <div className='target  absolute text-white top-[90%] left-1/2 -translate-x-1/2 -translate-y-1/2 h-1/2 z-30 w-[80%] h-[30%] bg-black border rounded-md flex items-center'>
